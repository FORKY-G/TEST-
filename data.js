...
const poiData = [ 
    ...
    { name: "41", type: "적", color: "#e74c3c", coords: mcToPx(1601, 5485), mcX: 1601, mcZ: 5485 }, { name: "42", type: "적", color: "#e74c3c", coords: mcToPx(2129, 6598), mcX: 2129, mcZ: 6598 }, { name: "43", type: "황", color: "#f1c40f", coords: mcToPx(-960, 2033), mcX: -960, mcZ: 2033, order : 4, lineType : "solid" }, { name: "44", type: "황", color: "#f1c40f", coords: mcToPx(-2468, 4433), mcX: -2468, mcZ: 4433, order : 6, lineType : "dotted" }, { name: "45", type: "적", color: "#e74c3c", coords: mcToPx(-5443, 4139), mcX: -5443, mcZ: 4139 }, { name: "46", type: "적", color: "#e74c3c", coords: mcToPx(4024, 3356), mcX: 4024, mcZ: 3356 }, { name: "47", type: "황", color: "#f1c40f", coords: mcToPx(658, 3900), mcX: 658, mcZ: 3900, order : 8, lineType : "solid" }, { name: "48", type: "녹", color: "#2ecc71", coords: mcToPx(-2121, -3837), mcX: -2121, mcZ: -3837, order : 15, lineType : "dotted" }, { name: "49", type: "청", color: "#3498db", coords: mcToPx(4886, 954), mcX: 4886, mcZ: 954, order : 12, lineType : "solid" }, { name: "50", type: "청", color: "#3498db", coords: mcToPx(4942, -1189), mcX: 4942, mcZ: -1189, order : 13, lineType : "dotted" }, 
    ...
    { name: "61", type: "적", color: "#e74c3c", coords: mcToPx(5258, 5723), mcX: 5258, mcZ: 5723 }, { name: "62", type: "녹", color: "#2ecc71", coords: mcToPx(1014, -2648), mcX: 1014, mcZ: -2648, order : 7, lineType : "solid" }, { name: "63", type: "황", color: "#f1c40f", coords: mcToPx(2705, 2461), mcX: 2705, mcZ: 2461, order : 11, lineType : "solid" }, { name: "64", type: "황", color: "#f1c40f", coords: mcToPx(-4029, 2321), mcX: -4029, mcZ: 2321, order : 2, lineType : "dotted" }, { name: "65", type: "황", color: "#f1c40f", coords: mcToPx(-790, 4284), mcX: -790, mcZ: 4284, order : 7, lineType : "solid" } 
]; 
